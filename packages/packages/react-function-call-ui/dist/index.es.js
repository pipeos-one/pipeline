...
import 'prop-types';
import { View, Icon, Text, Input, Label, Item, Accordion, Content, Card, CardItem, Button, H1, Right, Left } from 'native-base';
  ...
  createClass(FunctionIo, [{
    ...
    value: function _renderHeader(item, expanded) {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          expanded ? React.createElement(Icon, { style: { fontSize: 18 }, name: 'remove-circle' }) : React.createElement(Icon, { style: { fontSize: 18 }, name: 'add-circle' }),
          React.createElement(
            Item,
    ...
    value: function _renderContent(item) {
      ...
      return (item.components || []).map(function (subio, i) {
        return React.createElement(FunctionIo, {
          key: i,
    ...
    value: function render() {
      ...
      if (!item) return React.createElement(
        Text,
        null,
        '---'
      );
      ...
      return React.createElement(
        ...
        !item.components || item.components.length === 0 ? React.createElement(
          Item,
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              CardItem,
              null,
              React.createElement(FunctionIo, {
                item: ioGapiInputs,
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(Icon, { type: 'MaterialCommunityIcons', name: 'close' })
            )
          ),
          React.createElement(
            Right,
            ...
            React.createElement(
              ...
              React.createElement(Icon, { type: 'MaterialCommunityIcons', name: 'play' })
            )
          )
        )
      );
...
export { FunctionIo, FunctionCall };
